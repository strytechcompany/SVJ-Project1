                      ...
                      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 5 }}>
                        ...
                        >
                          <Icon
                            ...
                            size={20}
                            color={isSgstEnabled ? "#B8860B" : "#666"}
                          />
                        </TouchableOpacity>
                      ...
                      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 5 }}>
                        ...
                        >
                          <Icon
                            ...
                            size={20}
                            color={isCgstEnabled ? "#B8860B" : "#666"}
                          />
                        </TouchableOpacity>
                      ...
                      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 5 }}>
                        ...
                        >
                          <Icon
                            ...
                            size={20}
                            color={isIgstEnabled ? "#B8860B" : "#666"}
                          />
                        </TouchableOpacity>
                        ...
                        <View key={index} style={styles.tableRow}>
                          ...
                          <View style={styles.td}>
                            <Icon
                              ...
                              size={20}
                              color={row.gstEnabled ? "#B8860B" : "#ccc"}
                            />
                          </View>
