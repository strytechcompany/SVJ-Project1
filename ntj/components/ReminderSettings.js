        ...
        <View style={styles.card}>
          <View style={styles.row}>
            ...
            <Switch
              ...
              thumbColor={settings.enabled ? "#2E7D32" : "#f4f3f4"}
            />
          </View>
          ...
          <View style={styles.row}>
            ...
            <Switch
              ...
              trackColor={{ false: "#ccc", true: "#81C784" }}
              thumbColor={settings.inAppOnly ? "#2E7D32" : "#f4f3f4"}
            />
          </View>
...
const styles = StyleSheet.create({
  ...
  content: { padding: 20 },
  sectionTitle: { fontSize: 18, color: "#1B4D1B", marginBottom: 12, fontWeight: "bold" },
  card: {
    backgroundColor: "#fff",
    borderRadius: 10,
    padding: 15,
