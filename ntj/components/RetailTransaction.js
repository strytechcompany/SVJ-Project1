    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.page}>
          ...
          right={
          <TouchableOpacity onPress={() => navigation.navigate("RetailTransactionHistory")}> 
...
const styles = StyleSheet.create({
  ...
  historyBtn: { backgroundColor: "#B8860B", padding: 6, borderRadius: 12 },
  ...
  resultBox: { backgroundColor: "#FFF8E1", width: "48%", borderRadius: 10, padding: 12 },

  addBtn: { backgroundColor: "#B8860B", padding: 12, borderRadius: 18, alignItems: "center", marginTop: 10 },
  ...
  printBtn: { backgroundColor: "#7A5C00", borderRadius: 12, padding: 12, width: "45%", alignItems: "center" },

  // UPI styles
  upiHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 10 },
  addUpiBtn: { backgroundColor: "#3D2800", padding: 8, borderRadius: 20 },
  ...
  qrBtn: { backgroundColor: "#3D2800", padding: 8, borderRadius: 6, marginHorizontal: 2 },
  editUpiBtn: { backgroundColor: "#B8860B", padding: 8, borderRadius: 6, marginHorizontal: 2 },
  ...
  modalSaveBtn: { backgroundColor: "#3D2800", padding: 12, borderRadius: 8, flex: 1, alignItems: "center" },
