...
export default function DealerBill({ navigation, route }) {
    ...
    const currentBalance = Number(dealer.oldBalance || 0) + Number(dealer.advanceBalance || 0);
    ...
    const handleShare = async () => {
        try {
            ...
            message += `Current Balance: ${Number(currentBalance || 0).toFixed(3)} g\n`;
                ...
                <View style={styles.billContainer}>
                    ...
                    <View style={styles.summarySection}>
                        <View style={styles.summaryRow}>
                            ...
                            <Text style={styles.summaryValue}>{Number(currentBalance || 0).toFixed(3)} g</Text>
                        </View>
                        <View style={styles.summaryRow}>
