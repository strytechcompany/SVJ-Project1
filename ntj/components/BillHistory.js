      ...
      <View style={styles.billCard}>
        ...
        <View style={styles.actionRow}>
          {isLatest ? (
            ...
            >
              <Icon name="pencil" size={16} color="#B8860B" />
              <Text style={[styles.actionText, { color: "#B8860B" }]}>Edit</Text>
            </TouchableOpacity>
          ) : null}
...
const styles = StyleSheet.create({
  ...
  billType: { fontSize: 13, fontWeight: "bold", color: "#B8860B" },
  billNoBadge: {
  ...
  billNoText: { fontSize: 11, fontWeight: "bold", color: "#3D2800" },
  ...
  abLabel: { color: "#B8860B" },
  abValue: { color: "#B8860B" },
  pureTotalsRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  balanceInfo: { flex: 1 },
  customerNameMain: { fontSize: 18, fontWeight: "bold", color: "#3D2800" },
  ...
  abBadge: { backgroundColor: "#FFF8E1" },
