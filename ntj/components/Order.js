...
export default function Order({ navigation }) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      {loading ? (
        <ActivityIndicator size="large" color="#3D2800" style={{ marginTop: 30 }} />
      ) : (
        <ScrollView
    ...
    <View style={styles.card}>
        ...
        <View style={styles.actionIcons}>
          {item.status !== "Delivery" && (
            <TouchableOpacity onPress={() => onStatusMove(item)} style={styles.iconBtn}>
              <Icon name="arrow-right-circle" size={24} color="#3D2800" />
            </TouchableOpacity>
          )}
          <TouchableOpacity onPress={() => onEdit(item)} style={styles.iconBtn}>
            <Icon name="pencil-outline" size={20} color="#3D2800" />
          </TouchableOpacity>
      ...
      <View style={styles.cardFooter}>
        <View style={{ flex: 1, marginRight: 10, flexDirection: 'row', alignItems: 'center' }}>
          ...
          {item.dealerId ? (
            <TouchableOpacity
              ...
              style={{ marginLeft: 8 }}
            >
              <View style={{ backgroundColor: '#FFF8E1', padding: 6, borderRadius: 6 }}>
        ...
        <View style={styles.footerActions}>
          ...
          <TouchableOpacity
            style={[styles.smallActionBtn, { backgroundColor: '#3D2800' }]}
            onPress={() => onView(item)}
          >
...
const styles = StyleSheet.create({
  ...
  activeTab: { backgroundColor: "#3D2800" },
