    ...
    try {
      ...
      const itemsList = data
        .map((item) => ({
          ...
          type: item.type,
          issue: item.issue, // Include issue flag
          receipt: item.receipt, // Include receipt flag
          date: item.date,
        }))
                    ...
                    .map((it, idx) => (
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          ...
                          setReceiptStone(it.buyingTouch?.toString() || ""); // ✅ Buying Touch reflects in Result field
                          setReceiptTouch("100"); // Auto-fill purity with 100 for correct math
                        }}
                      >
