...
export default function ReportScreen({ navigation }) {
  ...
  const getDealerBalanceLabel = (r = {}) => {
    ...
    if (ab > 0) return { label: `AB: ${ab.toFixed(3)}`, color: "#B8860B" };
    ...
    return `
      ...
      <head>
        <style>
          ...
          th { background: #7A5C00; color: white; }
          .section-title { background: #FFF8E1; font-weight: bold; padding: 6px; margin-top: 12px; }
        </style>
      </head>
      <body>
                  ...
                  return rows.map((r, i) => {
                    ...
                    return (
                      <View key={i} style={styles.tableRow}>
                        ...
                        <Text style={[styles.tCell, { color: ab > 0 ? '#B8860B' : ob > 0 ? '#D32F2F' : '#666', fontWeight: 'bold' }]}>
                  ...
                  return filterByDate(purchaseData)
                    ...
                    .map((e, i) => (
                      <View key={i} style={styles.tableRow}>
                        ...
                        <Text style={styles.tCell}>{e.phone || "-"}</Text>
                        <Text style={styles.tCell}>{e.itemName || e.item || "-"}</Text>
                        <Text style={[styles.tCell, { color: '#B8860B', fontWeight: 'bold' }]}>{e.weight}</Text>
                        <Text style={styles.tCell}>{e.date}</Text>
                      </View>
                    ));
                })()}
                  ...
                  filteredObAbRows.map((r, i) => {
                    ...
                    return (
                      <View key={`${r.id}-${i}`} style={styles.tableRow}>
                        ...
                        <Text style={[styles.tCell, { color: '#B8860B', fontWeight: 'bold' }]}>
...
const styles = StyleSheet.create({
  ...
  dateTitle: { fontSize: 12, color: "#7A5C00" },
  ...
  tabBtn: { backgroundColor: "#7A5C00", padding: 8, borderRadius: 6 },
  activeTabBtn: { backgroundColor: "#000" },
  tabText: { color: "#fff", fontWeight: "bold" },

  tableTitle: { fontSize: 16, fontWeight: "bold", marginVertical: 10, color: "#7A5C00" },
  tableTotalText: { fontSize: 14, fontWeight: "bold", color: "#7A5C00", marginHorizontal: 8 },
  ...
  summaryValueGreen: { color: "#B8860B" },
  tableSearchInput: { backgroundColor: "#fff", padding: 8, borderRadius: 6, borderWidth: 1, borderColor: "#ccc", width: 150 },
  tableFilterBtn: { backgroundColor: "#7A5C00", padding: 8, borderRadius: 6, marginLeft: 10 },
  ...
  tableHeader: { flexDirection: "row", backgroundColor: "#7A5C00", paddingVertical: 5, paddingHorizontal: 4, borderRadius: 4 },
  tableRow: { flexDirection: "row", backgroundColor: "#FFF8E1", borderBottomWidth: 1, borderBottomColor: "#c8e6c9", paddingVertical: 3, paddingHorizontal: 4 },
