      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.card}>
          <View style={styles.labelRow}>
            ...
            <TouchableOpacity onPress={fetchSuppliers}>
              <Icon name="refresh-cw" size={16} color="#B8860B" />
            </TouchableOpacity>
          </View>
          <TouchableOpacity
        ...
        <View style={styles.card}>
          <View style={styles.labelRow}>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <TouchableOpacity onPress={fetchItems} style={{ marginLeft: 8 }}>
                <Icon name="refresh-cw" size={14} color="#B8860B" />
              </TouchableOpacity>
            </View>
          ...
          <TouchableOpacity style={styles.addItemBtn} onPress={addIssueEntry}>
            <Icon name="plus-circle" size={18} color="#B8860B" />
        ...
        <View style={styles.card}>
          <View style={styles.labelRow}>
            ...
            <View style={[styles.weightBadgeContainer, { paddingHorizontal: 12, paddingVertical: 6 }]}>
              <Icon name="shopping-cart" size={14} color="#B8860B" />
            ...
            {savedList.map((item) => (
              <View key={item.id} style={styles.savedRow}>
                ...
                <View style={styles.actionButtons}>
                  ...
                  >
                    <Icon name="edit-2" size={16} color="#B8860B" />
                  ...
                  return filtered.length === 0 ? (
                    ...
                    >
                      <View style={styles.itemIconContainer}>
                        <Icon name="user" size={18} color="#B8860B" />
                      </View>
                      <View style={{ flex: 1 }}>
                ...
                (() => {
                  ...
                  return filtered.length === 0 ? (
                    ...
                    return (
                      ...
                      >
                        <View style={styles.itemIconContainer}>
                          <Icon name="package" size={18} color="#B8860B" />
                        </View>
                        <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  ...
  addItemText: { color: '#B8860B', fontWeight: 'bold', fontSize: 14 }
});
