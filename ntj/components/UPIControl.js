...
const styles = StyleSheet.create({
  ...
  handleChip: { backgroundColor: "#FFF8E1", paddingHorizontal: 10, paddingVertical: 6, borderRadius: 15, borderWidth: 1, borderColor: "#B8860B" },
  handleChipText: { fontSize: 13, color: "#3D2800", fontWeight: "600" },
  ...
  closeQrBtn: { marginTop: 25, backgroundColor: "#3D2800", paddingVertical: 12, paddingHorizontal: 40, borderRadius: 25 },
