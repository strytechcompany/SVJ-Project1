      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.page}>
          <View style={styles.header}>
            ...
            <Text style={[styles.headerTitle, { top: 10 }]}>Suspense Transaction</Text>
            <TouchableOpacity style={{ marginLeft: 'auto', top: 10 }} onPress={() => navigation.navigate("SuspenseHistoryScreen")}>
