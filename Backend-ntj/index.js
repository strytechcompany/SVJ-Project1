...
const seedDefaultUser = async () => {
  try {
    ...
    // Seed SVJ admin from .env
    const defaultEmail = (process.env.DEFAULT_EMAIL || 'srivaishnavijeweller@gmail.com')
      .toLowerCase()
      .trim();
    ...
    if (!svjExists) {
      ...
      await svjUser.save();
      console.log(`SVJ admin seeded: ${defaultEmail}`);
    } else {
      console.log(`SVJ admin already exists: ${defaultEmail}`);
    }
  } catch (err) {
